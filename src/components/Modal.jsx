...
const Modal = ({setModal, animarModal, setAnimarModal, addGastos, gastoEditar, setGastoEditar})=>{
    ...
    const handleSubmit = e =>{
        ...
        addGastos({nombre, cantidad, categoria, fecha, id});
    }
    return (
        <div className="modal">
            <div className="cerrar-modal">
                <img src={CerrarModal} alt="cerrar modal" onClick={handledModal}/>
            </div>
